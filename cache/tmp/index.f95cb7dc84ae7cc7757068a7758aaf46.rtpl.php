...
<?php $counter1=-1; if( isset($array) && is_array($array) && sizeof($array) ) foreach( $array as $key1 => $value1 ){ $counter1++; ?>
<div class="btn-toolbar">
  <div class="btn-group">
    <a class="btn btn-success" href="action.php?engine=id-<?php echo $key1;?>&amp;action=CHANGE_STATE&amp;code=<?php echo $key1;?>&amp;state=on" ><?php echo $key1;?></a>
    <a class="btn btn-danger"  href="action.php?engine=id-<?php echo $key1;?>&amp;action=CHANGE_STATE&amp;code=<?php echo $key1;?>&amp;state=off"><?php echo $key1;?></a>
  </div>
</div>
<?php } ?>
